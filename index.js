...
(async () => {
    //const url = 'mongodb://localhost:27017'; quando era uma aplicacao local
    const url = 'mongodb+srv://admin:QEpcXWYViYgpW0PM@cluster0.2dekd.mongodb.net/ocean_db?retryWrites=true&w=majority';
   
    //const dbName = 'ocean_database_03_02_2021'; quando era uma aplicacao local
